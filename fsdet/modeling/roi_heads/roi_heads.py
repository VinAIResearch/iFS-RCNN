...
class StandardROIHeads(ROIHeads):
    ...
    def _init_box_head(self, cfg):
        ...
        if self.box_iou_on:
            ...
            in_channels_2 = in_channels + 4 if self.use_box_uncertainty else in_channels
            self.box_iou_head = build_box_head(
                cfg,
                ShapeSpec(
    ...
    def _forward_box(self, features, proposals):
        ...
        if self.box_iou_on:
            if self.training:
                boxes = outputs.predict_boxes_iou()
                ...
                gt_ious = matched_boxlist_iou(proposals, gt_boxes)

                keep = gt_ious > self.box_iou_thres
